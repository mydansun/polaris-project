...
class PinterestRef(BaseModel):
    ...
    # S3 URL for a server-side Gaussian-blurred thumbnail.  Populated
    # by ``pinterest_search_node`` for every successfully-downloaded
    # ref BEFORE scoring runs.  This is the ONLY ref-image surface
    # exposed to the chat UI — original Pinterest CDN URLs / bytes
    # never reach the frontend.
    blurred_url: str | None = None
