...
from polaris_design_intent.nodes.pinterest import (
    pinterest_score_node,
...
def build_graph(
    ...
    *,
    ...
    Nodes:
      ...
      - mood_board_step: gpt-image-1.5 ``images.edit`` call using the
    ...
    graph.add_conditional_edges(
        ...
        route_after_review,
        {
            REVIEW_ROUTE_PINTEREST: "pinterest_search",
            ROUTE_BACK_TO_CLARIFIER: "clarifier_step",
        },
    )
    graph.add_edge("pinterest_search", "pinterest_score")
    graph.add_edge("pinterest_score", "compiler")
