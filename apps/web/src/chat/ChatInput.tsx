        ...
        <div className="absolute bottom-2 right-2 flex items-center gap-2">
          ...
          {showStop === true && onStop !== undefined ? (
            <>
              ...
              {/* Steer-mode send button — only enabled when the parent
                  has explicitly opted in via canSend (codex active +
                  non-empty input).  Outline variant so it reads as a
                  subordinate "supplement" action, not a fresh-turn
                  primary. */}
              <Button
                type="submit"
                size="icon"
