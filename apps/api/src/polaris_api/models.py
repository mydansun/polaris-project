...
class Deployment(Base):
    ...
    # MinIO public URL of a Playwright-captured screenshot taken right
    # after smoke succeeds.  HomePage cards render this in preference
    # to ``design_intents.mood_board_url``.  Null until the publish
    # pipeline's screenshot step lands or a seed loader writes one.
